...
function SideBar({ toggle, setToggle }) {
  ...
  return (
    ...
    >
      <span href="#" className="closebtn" onClick={toggleSidebars}>
        <Toggle />
      </span>
      <p
        style={
      ...
      <span href="#" id="dashboard" className="anchor" onClick={currentLink}>
        <Dashboard /> {toggle ? "" : " Dashboard"}
      </span>
      <span href="#" id="apply" className="anchor" onClick={currentLink}>
        <Apply />
        {toggle ? "" : " Apply for a Loan "}
      </span>
      <span href="#" id="repay" className="anchor" onClick={currentLink}>
        <Apply />
        {toggle ? "" : " Repayments"}
      </span>
      <div
      ...
      >
        ...
        <span href="#" id="profile" className="anchor" onClick={currentLink}>
          <Profile />
          {toggle ? "" : " Profile"}
        </span>
        <span href="#" id="change-password" className="anchor" onClick={currentLink}>
          <Keys />
